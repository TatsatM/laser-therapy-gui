...
def main():
    ...
    hip_img_path = resource_path("image/bodyparts/hip.png")
    anatomy_img_path = resource_path("image/anatomy.png")
    hip_photo, anatomy_photo = load_and_resize_images(hip_img_path, anatomy_img_path, scale_factor)
